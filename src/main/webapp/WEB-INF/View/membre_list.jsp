            ...
            <tbody>
			  <c:forEach items="${membres}" var="membre">
	              <tr>
	                ...
	                <td class="center"><a href="membre_details?id=${membre.getId() }">Details<ion-icon class="details" name="information-circle-outline"></ion-icon></a></td>
	              </tr>
              </c:forEach>

              <!-- TODO : parcourir la liste des membres et les afficher selon la structure d'exemple ci-dessus CF JSTL -->
            </tbody>
          </table>
        </div>
      </div>
