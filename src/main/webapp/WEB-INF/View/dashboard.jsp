      ...
      <div class="row">
        <div class="col l4 s6">
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3>${countMembre}</h3> <!-- TODO : afficher le nombre de membres à la place de 12 -->
              <p>Membres</p>
            </div>
            <div class="icon">
        ...
        <div class="col l4 s6">
          <div class="small-box bg-green">
            <div class="inner">
              <h3>${countLivres}</h3> <!-- TODO : afficher le nombre de livres à la place de 27 -->
              <p>Livres</p>
            </div>
            <div class="icon">
        ...
        <div class="col l4 s6">
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3>${countEmprunts}</h3> <!-- TODO : afficher le nombre d'emprunts à la place de 1515 -->
              <p>Emprunts</p>
            </div>
            <div class="icon">
                ...
                <tbody id="results">
                    ...
                    <c:forEach items="${emprunts}" var="item">
	                    <tr>
	                        ...
	                        <td>
	                            <a href="emprunt_return?id=${item.getId() }">Retour<ion-icon class="table-item" name="log-in"></a>
	                        </td>
	                    </tr>
                    </c:forEach>
                </tbody>
